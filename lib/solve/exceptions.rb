module Solve
	# Base class for all solve exceptions.
	class Exception < ::RuntimeError; end

	# Client was not authorized by remote server; check credentials.
	class NotAuthorized < Exception; end

	# solved is not running on the remote box.
	class SolvedNotRunning < Exception; end

	# An unrecognized status code was returned by solved.

# An instance of this class is returned by Solve::Commands#search.  It contains
...
#
# SearchResults mixes in Solve::Commands so that you can chain multiple searches
...
class Solve::SearchResults
	...
	# Add a Solve::Entry and the array of string matches.
	def add(entry, lines)
